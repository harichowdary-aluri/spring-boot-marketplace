...
public class AutomobilesController {
    ...
    public List<Automobiles> getAllAutomobiles(){
    	...
    	return service.getAllAutomobilesByStatus("Available");
    }
    ...
    public Automobiles updateAutomobileImages(@PathVariable int id,@RequestParam("images") MultipartFile[] files) throws JsonProcessingException {
    	...
    	automobile.setImages(s3service.getImageLinks(files));
...
//            System.out.println("----------------------------------");
    ...
    public List<Automobiles> getAllAutomobilesByStatus(@RequestParam("status") String status){
        return service.getAllAutomobilesByStatus(status);
    }
